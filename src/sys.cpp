...
{
    char buf[256];
    if(view == SYS::Dec)	snprintf(buf,sizeof(buf),"%d",val);
    else if(view == SYS::Oct)	snprintf(buf,sizeof(buf),"%o",val);
    else if(view == SYS::Hex)	snprintf(buf,sizeof(buf),"%x",val);
...
{
    char buf[256];
    if(view == SYS::Dec)	snprintf(buf,sizeof(buf),"%u",val);
    else if(view == SYS::Oct)	snprintf(buf,sizeof(buf),"%o",val);
    else if(view == SYS::Hex)	snprintf(buf,sizeof(buf),"%x",val);
...
{
    char buf[256];
    if(view == SYS::Dec)	snprintf(buf,sizeof(buf),"%lld",val);
    else if(view == SYS::Oct)	snprintf(buf,sizeof(buf),"%llo",val);
    else if(view == SYS::Hex)	snprintf(buf,sizeof(buf),"%llx",val);
