...
Table *DataBaseSqlite::openTable(const string &inm,bool create)
{
...
TableSqlite::TableSqlite(string inm,DataBaseSqlite *iown,bool create) : Table(inm)
{
    setNodePrev(iown);
    try
    {
...
{
    return (DataBaseSqlite&)Table::owner();
}
